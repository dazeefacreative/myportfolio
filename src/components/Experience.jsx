...
const clients = [
  {
    ...
    {
    id: 5,
    name: "Endrick Williams",
    title: "Founder, Superb Shot Ltd",
    ...
    return(
        <section id="experience">
            <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 w-full max-w-6xl mx-auto gap-y-10 gap-2 lg:gap-y-16 px-6 py-12">
                <div className="col-span-1 md:col-span-2 lg:col-span-4 justify-center items-center md:items-start flex flex-col gap-6">
